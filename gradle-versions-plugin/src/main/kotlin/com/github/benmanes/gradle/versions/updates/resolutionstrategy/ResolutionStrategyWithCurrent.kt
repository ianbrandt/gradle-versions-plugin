...
class ResolutionStrategyWithCurrent private constructor(
   ...
   * than the report the judge replays rules over. [onDeprecatedBoundRead] takes no default: a rule
   * reading the deprecated bound has to be warned about at the judge as well, since a restored
   * configuration cache entry spares the resolution that would otherwise have warned.
   */
  internal constructor(
