    ...
    private fun writeUnresolved(
      ...
      if (unresolved.isNotEmpty()) {
        ...
        for (dependency in unresolved) {
          ...
          // The resolver's own account of the failure, which names causes the coordinate cannot
          // show. A build with no repositories reports every coordinate it declares here, and
          // until this line said so the report gave no hint of why. Reported as the first line
